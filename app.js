...
app.post('/send', (req, res) => {
    const emailShiping = `
        ...
        <tr>
        <td class="table-content-wrap" style="margin: 0;padding: 0;background-color: #ffffff;padding-top: 49px;padding-bottom: 75px;">
        ...
        <tbody>
        <tr>
        <td align="center" class="text table-content-title table-padding-both" style="margin: 0;padding: 0;mso-line-height-rule: exactly;font-style: normal;letter-spacing: normal;color: #000000;font-family: Arvo, Arial, sans-serif;font-size: 28px;line-height: 34px;padding-left: 10px;padding-right: 10px;">
        ...
        <a target="_blank" href="" class="table-content-button" style="font-family: &quot;Open Sans&quot;, Arial, sans-serif;display: block;width: 230px;height: 60px;background-color: #12a0d2;text-decoration: none;color: #ffffff;line-height: 60px;font-weight: 700;font-size: 14px;text-transform: uppercase;-webkit-transition: 0.3s;-o-transition: 0.3s;transition: 0.3s;">Track my order</a>
        </td>
        </tr>
        <tr>
        <td align="center" class="text table-content-title" style="margin: 0;padding: 0;mso-line-height-rule: exactly;font-style: normal;letter-spacing: normal;color: #000000;font-family: Arvo, Arial, sans-serif;font-size: 28px;line-height: 34px;">
        Have any questions?
        </td>
        </tr>
        <tr>
...
<tr>
<td class="table-order-wrap" style="margin: 0;padding: 0;padding-left: 32px;padding-right: 32px;padding-top: 30px;">
...
Order total:
<p style="margin: 0;padding: 0;font-size: 14px;font-weight: normal;padding-top: 8px;line-height: 24px;">Renews every 30 days. Cancel anytime. <a href="#" class="link table-content-link" style="color: #12a0d2;text-decoration: none;font-family: &quot;Open Sans&quot;, Arial, sans-serif;display: block;font-size: 14px;line-height: 26px;">More information</a></p>
</td>
</tr>
<tr>
